...
def parse_args():
    ...
    parser.add_argument("-c","--characters", type=str ,help="characters to include (default: ASCII)", default="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~")
